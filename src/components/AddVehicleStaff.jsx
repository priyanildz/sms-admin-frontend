...
const VehicleStaffModal = ({ isOpen, onClose }) => {
  ...
  const AUTH_HEADER = "ZjVGZPUtYW1hX2FuZHJvaWRfMjAyMzY0MjU="; // Fetch data when modal opens
  ...
  const fetchData = async () => {
    try {
      ...
      setLoading(true);
      setError(null); // FIX 1: Using imported API_BASE_URL (for drivers/supervisors)
      ...
      ].filter(Boolean); // FIX 2: Using imported API_BASE_URL (for vehicles)
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log("payload: ", payload); // FIX 3: Using imported API_BASE_URL
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <SelectField
              ...
              placeholder={
                loading ? "Loading vehicle nos..." : "Select Vehicle No"
              }
              disabled={loading}
            />
          </div>
          ...
          <div>
            ...
            <SelectField
              ...
              placeholder={
                loading ? "Loading supervisors..." : "Select Supervisor"
              }
              disabled={loading}
            />
          </div>
