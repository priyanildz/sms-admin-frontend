...
  // Stores map of { "PUC Certificate": FileObject } for all uploaded documents
  const [pendingDocuments, setPendingDocuments] = useState({});
  // State for the currently selected document type in the dropdown
...
    const file = e.target.files[0];
    // docType is stored in currentDocType state
...
        // Ensure we only process files for the keys we know how to map
...
      // 2. Prepare Final Data and Save to DB
      const finalFormData = {
        ...formData,
...
      }}
    >
      {/* MODIFICATION 1: max-w-4xl and fixed height/scrolling */}
...
          
          {/* ------------------ START OF NESTED GRID (Details + Image) ------------------ */}
          <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6">
            
            {/* LEFT COLUMN: Basic Details */}
            <div className="space-y-6">
              {/* Group 1: Vehicle Basic Details */}
...
            {/* RIGHT COLUMN: Vehicle Image Upload */}
...
                  {/* MODIFICATION 2: Reduced size of Image Preview box */}
                  <div
...
                {/* MODIFICATION 3: Status Toggle placed correctly below the image/upload */}
...
          {/* ------------------ START OF FULL WIDTH BLOCK (Documents) ------------------ */}
          {/* Group 2: Document Uploads (Using Dropdown/List Pattern) - Now full width */}
...
                {currentDocType !== VEHICLE_DOCUMENT_OPTIONS[0] && (
                  <div>
...
                      // Key is crucial here to force re-render/clear input when dropdown changes
                      key={currentDocType}
...
                  Files Pending Upload on Submission:
                </h5>
                <ul className="space-y-2 text-sm text-gray-700">
                  {VEHICLE_DOCUMENT_OPTIONS.filter(
...
            </div>
          </div>
          {/* ------------------ END OF FULL WIDTH BLOCK (Documents) ------------------ */}
