...
export default function ViewTeacherTimetable() {
  ...
  const fetchTeacherDetailsAndTimetable = useCallback(async () => {
    ...
    try {
      ...
      const staffDetailsRes = await axios.get(
      ...
      const teacherTimetableRes = await axios.get(
        `${API_BASE_URL}api/staff/${staffInfo.staffid}/timetable`,
        {
          headers: {
            auth: AUTH_HEADER,
            username: storedUsername,
      ...
      <div className="bg-white rounded-2xl shadow p-8 min-h-[500px]">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <div className="text-blue-500 italic font-medium">
