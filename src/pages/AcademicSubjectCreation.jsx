...
const AcademicSubjectCreation = () => {
  ...
  const handleDelete = async (id) => {
    if (
      window.confirm(
        "Are you sure you want to delete this subject configuration?",
      )
    ) {
      try {
                  ...
                  filteredSubjects.map((item, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 border border-gray-300 text-center">
                        {Array.isArray(item.subjectName)
                      ...
                      <td className="px-6 py-4 border border-gray-300 text-center">
                        <div className="flex justify-center items-center gap-2">
                          <button
                            onClick={() =>
                              navigate(
                                `/academics-edit-subject/${item.standard}`,
                              )
                            }
                          ...
                          <button
                            onClick={() =>
                              navigate(
                                `/academics-view-subject/${item.standard}`,
                              )
                            }
