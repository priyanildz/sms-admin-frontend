...
            return setNotification({ type: 'error', message: 'Pickup Location is required when transport is "Yes".' });
        }
        // 🟢 ADDED: Drop Location check
        if (transportData.transportstatus === 'yes' && !transportData.droppoint) {
            return setNotification({ type: 'error', message: 'Drop Location is required when transport is "Yes".' });
        }
...
                            <div className="p-4 md:p-6 bg-gray-50 flex items-center">
                                <label className="text-base md:text-lg font-medium text-gray-700">
                                    Pickup Location <span className="text-red-500">*</span> {/* 🟢 ADDED ASTERISK */}
                                </label>
                            </div>
                            <div className="p-4 md:p-6">
                                <input
...
                            <div className="p-4 md:p-6 bg-gray-50 flex items-center">
                                <label className="text-base md:text-lg font-medium text-gray-700">
                                    Drop Location <span className="text-red-500">*</span> {/* 🟢 ADDED ASTERISK */}
                                </label>
                            </div>
                            <div className="p-4 md:p-6">
                                <input
