...
//         const group = tableGroups.find(g => g.name === selectedStd);
//         if (group) {
//             // Use a for...of loop or Promise.allSettled to prevent 404s from stopping the process
//             for (const id of group.allIds) {
//                 try {
//                     await axios.delete(`${API_BASE_URL}api/allotments/${id}`, config);
//                 } catch (err) {
//                     console.warn(`Record ${id} not found or already deleted, continuing...`);
//                 }
//             }
//         }
//     }

//     // Continue with POSTing the new rows
//     for (const row of allotmentRows) {
//         const selectedTeachers = row.teacherOptions.filter(t => t.teacher !== null);
//         for (const tOpt of selectedTeachers) {
//             const payload = {
...
//     alert("Error saving allotment. Check console for details."); 
// }
//     };
