                  ...
                  {students.map((student, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      <td className="py-2 px-4 border">
                        {safeRead(student, "firstname")}{" "}
                        {safeRead(student, "middlename")}
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-6 w-[90%] max-w-md relative">
            ...
            <p>
              ...
              {safeRead(selectedStudent, "middlename")}{" "}
              {safeRead(selectedStudent, "lastname")}
            </p>
            <p>
              <strong>DOB:</strong>{" "}
              {formatDate(safeRead(selectedStudent, "dob", null))}
            </p>
            <p>
              <strong>Blood Group:</strong>{" "}
              {safeRead(selectedStudent, "bloodgroup")}
            </p>
            <p>
            ...
            <p>
              ...
              {safeRead(selectedStudent, "aadharno")}
            </p>
            <p>
            ...
            <p>
              <strong>Gr no:</strong>{" "}
              {safeRead(selectedStudent, "admission.grno")}
            </p>
            <p>
              <strong>Address:</strong>{" "}
              {safeRead(selectedStudent, "address.addressline1")}{" "}
              {safeRead(selectedStudent, "address.addressline2")},{" "}
              {safeRead(selectedStudent, "address.city")}
            </p>
            <p>
              <strong>Transport Status:</strong>{" "}
              {safeRead(selectedStudent, "transport.transportstatus")}
            </p>
          </div>
        </div>
      )}
