...
const ExamPaperRecheck = () => {
  ...
  return (
    <MainLayout>
      <div className="bg-white rounded-2xl shadow p-6">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-xl font-semibold text-gray-800">Exam Paper Rechecking</h1>
          <button
              ...
              {rechecks.length > 0 ? (
                rechecks.map((entry, index) => (
                  <tr key={index} className="hover:bg-gray-50 transition-all">
                    ...
                    <td className="py-2 px-4 border text-center">{entry.standard}</td>
                    <td className="py-2 px-4 border text-center">{entry.division}</td>
                    <td className="py-2 px-4 border">{entry.examtype || "N/A"}</td>
                    <td className="py-2 px-4 border">{entry.subject}</td>
