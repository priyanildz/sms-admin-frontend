...
const TrackingModal = ({ isOpen, onClose, vehicle }) => {
  ...
  const simulatedStart =
    vehicle.routeName.split(",")[0].trim() || "Start Point";
        ...
        <div className="relative w-full h-[400px] border border-gray-400 rounded-lg shadow-xl overflow-hidden bg-gray-100">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-400 text-xl font-light bg-blue-100/50">
            ...
            <FontAwesomeIcon
              ...
              className="text-blue-500 text-4xl animate-pulse"
            />
          </div>
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20">
            <FontAwesomeIcon
              icon={faBusSimple}
              className="text-yellow-500 text-5xl border-4 border-black rounded-full p-1 shadow-2xl"
            />
          </div>
        </div>
...
const TransportTracking = () => {
  ...
  const filteredData = combinedTableData.filter((item) =>
