        ...
        <div className="p-6 space-y-6">
                ...
                {loading ? (
                  ...
                  formData.map((row, idx) => (
                    <tr key={idx} className="border-b transition-colors">
                      <td className="text-center px-6 py-3 border border-gray-300 font-medium text-sm">
                        {row.name}
                      </td>
                      <td className="px-6 py-3 border border-gray-300 text-center">
                        <div className="flex flex-col items-start gap-1 mx-auto w-fit">
                          {["Compulsory", "Optional"].map((t) => (
                            <label
                              key={t}
                              className="flex items-center gap-2 text-xs opacity-80 cursor-default"
                            >
                              <input
                                type="radio"
                                checked={row.type === t}
          ...
          <div className="flex justify-end mt-4">
            <button
              ...
              className="px-6 py-2 bg-blue-500 text-white rounded-md shadow hover:bg-blue-600 font-medium text-sm"
            >
              Back
            </button>
          </div>
