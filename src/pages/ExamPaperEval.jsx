...
//         if (window.confirm('Are you sure you want to delete this assignment?')) {
//             try {
//                 // FIX 2: Correctly using the delete endpoint (assuming it's /api/assigned-papers/:id)
//                 const response = await fetch(`${API_BASE_URL}api/assigned-papers/${id}`, {
//                     method: 'DELETE',
//                     headers: {
//                         auth: AUTH_TOKEN
//                     }
...
//                                             {new Date(entry.createdAt).toLocaleDateString()}
//                                         </td>
//                                         {/* ADDED ACTION CELL with DELETE button */}
//                                         <td className="py-2 px-4 border">
//                                             <button
//                                                 onClick={() => handleDelete(entry._id)}
//                                                 // Using default red text for delete, no color change required
                    ...
                    <table className="min-w-full text-sm border rounded-xl">
                        ...
                        <tbody>
                            {paperEvalData.length > 0 ? (
                                paperEvalData.map((entry) => (
                                    <tr key={entry._id} className="hover:bg-gray-50 transition-all">
                                        ...
                                        <td className="py-2 px-4 border font-semibold">
                                            <span className={entry.status === "Completed" ? "text-green-600" : "text-amber-500"}>
                                ...
                                <tr>
                                    <td colSpan="9" className="text-center py-6 text-gray-500 border">
                                        No paper evaluations available.
                                    </td>
                                </tr>
                            )}
