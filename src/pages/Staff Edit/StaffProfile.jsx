...
//     // --------------------------------------------------------
//     // API LOOKUP FUNCTIONS (Ported from Registration)
//     // --------------------------------------------------------
...
//                 }));
//             }
//         } catch (err) { console.error("IFSC lookup failed", err); }
//     };
...
//                 if (value && value.trim() && !/^\d{10}$/.test(value)) errorMsg = "Phone number must be 10 digits";
//                 break;
//             case "aadharno":
//                 if (!/^\d{12}$/.test(value)) errorMsg = "Aadhaar number must be 12 digits";
//                 break;
//             case "emailaddress":
//                 if (!/^\S+@\S+\.\S+$/.test(value)) errorMsg = "Invalid email format";
//                 break;
//             case "panno":
//                 if (!/^[A-Z]{5}[0-9]{4}[A-Z]{1}$/.test(value.toUpperCase())) errorMsg = "Invalid PAN format";
//                 break;
//             case "ifccode":
//                 if (!/^[A-Z]{4}0[A-Z0-9]{6}$/.test(value.toUpperCase())) errorMsg = "Invalid IFSC format";
//                 break;
//             default:
//                 break;
//         }
...
//         const fieldsToValidate = ['firstname', 'lastname', 'phoneno', 'alternatephoneno', 'aadharno', 'emailaddress', 'ifccode', 'panno'];
//         let hasErrors = false;
...
//     const ErrorMsg = ({ name }) => localErrors[name] ? (
...
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">First Name *</label>
//                                 <input type="text" name="firstname" value={staffData.firstname || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" disabled={isViewMode} required />
//                                 <ErrorMsg name="firstname" />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Middle Name</label>
//                                 <input type="text" name="middlename" value={staffData.middlename || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" disabled={isViewMode} />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Last Name *</label>
//                                 <input type="text" name="lastname" value={staffData.lastname || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" disabled={isViewMode} required />
//                                 <ErrorMsg name="lastname" />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Date of Birth *</label>
//                                 <input type="date" name="dob" value={staffData.dob || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" disabled={isViewMode} required />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Gender *</label>
//                                 <select name="gender" value={staffData.gender || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg bg-white" disabled={isViewMode} required>
//                                     <option value="">Select</option><option value="Male">Male</option><option value="Female">Female</option><option value="Other">Other</option>
//                                 </select>
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Marital Status *</label>
//                                 <select name="maritalstatus" value={staffData.maritalstatus || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg bg-white" disabled={isViewMode} required>
//                                     <option value="">Select</option><option value="Single">Single</option><option value="Married">Married</option><option value="Divorced">Divorced</option><option value="Widowed">Widowed</option>
//                                 </select>
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Blood Group *</label>
//                                 <select name="bloodgroup" value={staffData.bloodgroup || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg bg-white" disabled={isViewMode}>
//                                     <option value="">Select</option><option value="A+">A+</option><option value="A-">A-</option><option value="B+">B+</option><option value="B-">B-</option><option value="O+">O+</option><option value="O-">O-</option><option value="AB+">AB+</option><option value="AB-">AB-</option>
//                                 </select>
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Nationality</label>
//                                 <input type="text" name="nationality" value={staffData.nationality || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Category</label>
//                                 <input type="text" name="category" value={staffData.category || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                             </div>
//                             <div className="md:col-span-2">
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Aadhar Number *</label>
//                                 <input type="text" name="aadharno" value={staffData.aadharno || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
...
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Phone Number (Primary) *</label>
//                                 <input type="tel" name="phoneno" value={staffData.phoneno || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                                 <ErrorMsg name="phoneno" />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Alternate Phone Number</label>
//                                 <input type="tel" name="alternatephoneno" value={staffData.alternatephoneno || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                                 <ErrorMsg name="alternatephoneno" />
//                             </div>
//                             <div className="md:col-span-2">
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Email Address *</label>
//                                 <input type="email" name="emailaddress" value={staffData.emailaddress || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
...
//                             <div className="md:col-span-2">
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Address Line 1 *</label>
//                                 <input type="text" name="addressline1" value={staffData.addressline1 || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                                 <ErrorMsg name="addressline1" />
//                             </div>
//                             <div className="md:col-span-2">
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Address Line 2</label>
//                                 <input type="text" name="addressline2" value={staffData.addressline2 || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Postal Code *</label>
//                                 <input type="text" name="postalcode" value={staffData.postalcode || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">City *</label>
//                                 <input type="text" name="city" value={staffData.city || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">District</label>
//                                 <input type="text" name="district" value={staffData.district || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">State *</label>
//                                 <input type="text" name="state" value={staffData.state || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                             </div>
//                         </div>
//                     </div>
...
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Highest Qualification *</label>
//                                 <input type="text" name="highestqualification" value={staffData.highestqualification || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Year of Passing *</label>
//                                 <input type="text" name="yearofpassing" value={staffData.yearofpassing || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                             </div>
//                             <div className="md:col-span-2">
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">University Name *</label>
//                                 <input type="text" name="universityname" value={staffData.universityname || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                             </div>
//                             <div className="md:col-span-2">
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Specialization</label>
//                                 <input type="text" name="specialization" value={staffData.specialization || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                             </div>
//                         </div>
//                     </div>
...
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Total Experience (Years)</label>
//                                 <input type="text" name="totalexperience" value={staffData.totalexperience || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Designation</label>
//                                 <select name="designation" value={staffData.designation || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg bg-white" disabled={isViewMode}>
//                                     {POSITIONS.map(p => <option key={p} value={p}>{p || 'Select'}</option>)}
//                                 </select>
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Previous Employer</label>
//                                 <input type="text" name="previousemployer" value={staffData.previousemployer || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                             </div>
//                             <div className="md:col-span-2">
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Subjects Taught</label>
//                                 <input type="text" name="subjectstaught" value={staffData.subjectstaught || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                             </div>
//                         </div>
//                     </div>
...
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Position Applied For *</label>
//                                 <select name="position" value={staffData.position || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg bg-white" disabled={isViewMode} required>
//                                     {POSITIONS.map(p => <option key={p} value={p}>{p || 'Select'}</option>)}
//                                 </select>
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Department *</label>
//                                 <select name="dept" value={staffData.dept || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg bg-white" disabled={isViewMode} required>
//                                     {DEPARTMENTS.map(d => <option key={d} value={d}>{d || 'Select'}</option>)}
//                                 </select>
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Preferred Grades</label>
//                                 <select name="preferredgrades" value={staffData.preferredgrades || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg bg-white" disabled={isViewMode}>
//                                     {GRADES.map(g => <option key={g} value={g}>{g || 'Select'}</option>)}
//                                 </select>
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Joining Date *</label>
//                                 <input type="date" name="joiningdate" value={staffData.joiningdate || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                             </div>
//                         </div>
//                     </div>
...
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Bank Name *</label>
//                                 <input type="text" name="bankname" value={staffData.bankname || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Branch Name *</label>
//                                 <input type="text" name="branchname" value={staffData.branchname || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Account Number *</label>
//                                 <input type="text" name="accno" value={staffData.accno || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">IFSC Code *</label>
//                                 <input type="text" name="ifccode" value={staffData.ifccode || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                                 <ErrorMsg name="ifccode" />
//                             </div>
//                             <div className="md:col-span-2">
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">PAN Number *</label>
//                                 <input type="text" name="panno" value={staffData.panno || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
//                                 <ErrorMsg name="panno" />
//                             </div>
//                         </div>
//                     </div>
...
//                             <div>
//                                 <label className="block text-sm font-medium mb-1 text-gray-700">Transport Required? *</label>
//                                 <select name="transportstatus" value={staffData.transportstatus || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg bg-white" disabled={isViewMode} required>
//                                     <option value="">Select</option><option value="Yes">Yes</option><option value="No">No</option>
//                                 </select>
//                             </div>
//                             {staffData.transportstatus === 'Yes' && (
...
//                                     <div>
//                                         <label className="block text-sm font-medium mb-1 text-gray-700">Pickup Point</label>
//                                         <input type="text" name="pickuppoint" value={staffData.pickuppoint || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                                     </div>
//                                     <div>
//                                         <label className="block text-sm font-medium mb-1 text-gray-700">Drop Point</label>
//                                         <input type="text" name="droppoint" value={staffData.droppoint || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                                     </div>
//                                     <div>
//                                         <label className="block text-sm font-medium mb-1 text-gray-700">Mode of Transport</label>
//                                         <input type="text" name="modetransport" value={staffData.modetransport || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} />
//                                     </div>
//                                 </>
//                             )}
//                         </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select 
                                    ...
                                    value={staffData.transportstatus?.toLowerCase() === 'yes' ? 'Yes' : (staffData.transportstatus?.toLowerCase() === 'no' ? 'No' : '')} 
                            ...
                            {(staffData.transportstatus?.toLowerCase() === 'yes' || staffData.transportstatus === 'Yes') && (
                                <>
                                    <div>
                                        <label className="block text-sm font-medium mb-1 text-gray-700">Pickup Point *</label>
                                        <input type="text" name="pickuppoint" value={staffData.pickuppoint || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium mb-1 text-gray-700">Drop Point *</label>
                                        <input type="text" name="droppoint" value={staffData.droppoint || ''} onChange={onInputChange} className="w-full px-4 py-2 border rounded-lg" disabled={isViewMode} required />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium mb-1 text-gray-700">Mode of Transport *</label>
                                        <select 
                                            ...
                                            required
                                        >
                                            {TRANSPORT_MODES.map(mode => <option key={mode} value={mode}>{mode || 'Select'}</option>)}
                                        </select>
                                    </div>
                                </>
                            )}
