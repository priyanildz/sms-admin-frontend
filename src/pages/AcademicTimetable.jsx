...
// --- HOLIDAY DATA STRUCTURE (MANUALLY MAINTAINED) ---
// This list is now mainly for complex/moving holidays (like Diwali/Holi)
const HOLIDAYS = [
  // Keeping only complex/moving holidays here
  { date: '2025-03-14', name: 'Holi Festival' }, 
  { date: '2025-04-13', name: 'Ram Navami' },
  { date: '2025-05-01', name: 'Labour Day/Maharashtra Day' },
  { date: '2025-10-02', name: 'Gandhi Jayanti' },
  ...
  // Adding the next year's date for moving holidays for continuity
  { date: '2026-03-03', name: 'Holi Festival' }, // Example date for 2026
  { date: '2026-10-18', name: 'Diwali Holiday' }, // Example date for 2026
];
...
const isHoliday = (dateString) => {
    ...
    // 1. Check for perpetually recurring holidays (Jan 26, Aug 15)
